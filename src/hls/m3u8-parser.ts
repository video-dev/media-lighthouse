...
export default class M3U8Parser {
    public static findGroup(groups, mediaGroupId) {
        if (!groups) {
            return null;
        }
    ...
    public pulic; public static convertAVC1ToAVCOTI(codec) {
    ...
    public static resolve(url, baseUrl) {
        return URLToolkit.buildAbsoluteURL(baseUrl, url, { alwaysNormalize: true });
    }

    public static parseMasterPlaylist(string, baseurl) {
        let levels = [], result;
        ...
        while ((result = MASTER_PLAYLIST_REGEX.exec(string)) != null) {
            ...
            const attrs = level.attrs = new AttrList(result[1]) as any;
    ...
    public static parseMasterPlaylistMedia(string, baseurl, type, audioGroups = []) {
        let result;
        const medias = [];
        let id = 0;
        ...
        while ((result = MASTER_PLAYLIST_MEDIA_REGEX.exec(string)) !== null) {
            const media = {} as any;
            const attrs = new AttrList(result[1]) as any;
            if (attrs.TYPE === type) {
    ...
    public static parseLevelPlaylist(string, baseurl, id, type, levelUrlId) {
        let currentSN = 0;
        let totalduration = 0;
        const level = new Level(baseurl);
            ...
            if (duration) { // INF
                ...
                switch (result[i]) {
                    ...
                    case 'KEY':
                        ...
                        const keyAttrs = new AttrList(value1) as any;
                    ...
                    case 'START':
                        ...
                        const startAttrs = new AttrList(startParams);
                        ...
                        break;
                    case 'MAP':
                        const mapAttrs = new AttrList(value1) as any;
